...
import {TSMT$ISkipListNode} from "./SkipListNode";
...
export class TSMT$SkipListNode implements TSMT$ISkipListNode
{
  ...
  public prev: TSMT$SkipListNode;   // previous node in list (null if head)
  public next: TSMT$SkipListNode;   // next node in list (null if tail)
  public up: TSMT$SkipListNode;     // node one level down (null if none exists)
  public down: TSMT$SkipListNode;   // node one level up in list (null if none exists)
